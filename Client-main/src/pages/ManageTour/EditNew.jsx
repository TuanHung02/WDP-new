  ...
  const EditNew = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        await axios.post('http://localhost:8080/api/tour/updateNew', {
          "tour_name": nameTour,
        ...
        toast.success('Created new tour successfully!');
          ...
          <div style={{ marginTop: '2rem ', marginBottom: '6rem' }}>
            <div className="bg-white border border-4 rounded-lg shadow relative m-10">
              <div className="flex items-start justify-between p-5 border-b rounded-t">
                <h3 className="text-xl font-semibold">Create new Tour from existed</h3>
                <button
                  type="button"
